                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="p-20 m-b-20">
                                    ...
                                    <div class="m-b-20">
                                        <form method="POST" onsubmit="return validate();" enctype="multipart/form-data" action="config/functions.php" class="form-validation" novalidate>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" name="fileToUpload" parsley-trigger="change" class="form-control" id="image">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group text-right m-b-0">
                                                <button class="btn btn-primary waves-effect waves-light" type="submit" name="add_course">
                                                   Add Course
                                                </button>
