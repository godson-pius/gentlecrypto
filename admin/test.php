    ...
    <div class="content">
                        ...
                        <div class="m-b-20">
                            <form method="POST" onsubmit="return validate();" enctype="multipart/form-data"
                                ...
                                <div class="form-group">
                                    ...
                                    <div parsley-trigger="change" class="detail" id="summernote"></div>
                                </div>
        ...
        <script>
            function validate() {
                ...
                var detail = document.getElementByClassName("detail").value;
        ...
        <script type="text/javascript">
            ...
            $('.detail').on('keyup keydown change', function () {
                var len = document.getElementByClassName("detail").value;
                var len2 = len.length;
