                    ...
                    <div class="p-20 m-b-20">
                        ...
                        <div class="m-b-20">
                            <form onsubmit="return validate();" enctype="multipart/form-data"
                                action="config/functions.php" class="form-validation" method="POST" novalidate>

                                <div class="form-group">
                                    <label for="emailAddress">Date Added<span class="text-danger">*</span></label>
                                    <input type="text" readonly name="date"
                                        value="<?php echo date('d'.'-'.'m'.'-'.'Y'); ?>" parsley-trigger="change"
                                        class="form-control bg-light" id="date">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="price" parsley-trigger="change" required
                                        placeholder="Enter Lesson Price" class="form-control" id="price"
                                        onkeypress="return onlyPrice(event, this)" ondrop="return false;"
                                        onpaste="return false;" oncontextmenu="return false;" maxlength="10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <i class="fa fa-exclamation-triangle error" id="detail_error"
                                            aria-hidden="true"></i>
                                    </div>
            ...
            function validate() {
                ...
                if (detail.length == 0) {
                    ...
                    document.getElementById("detail_error").innerHTML =
                        "Write Brief details of this Lesson to help Learners ";
                    return false;
                } else {
