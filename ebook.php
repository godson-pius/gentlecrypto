			...
			<div class="row align-center">
				<div class="col-lg-8 col-lg-offset-2 col-md-12 col-sm-12 col-xs-12">
					<header class="crumina-module crumina-heading heading--h2 heading--with-decoration">
						...
						<div class="heading-text">Learn how to trade the crypto currency market by digesting the
							different pages of our eBook, which is currently having a competitive edge over other crypto
							currency trading eBooks out there. </div>
					</header>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 sorting-item">
					<div class="crumina-module crumina-event-item">
						...
						<div class="event-content">
							...
							<a href="ebook-details.php?ebook=fastlane"
								class="btn btn--medium btn--transparent btn--secondary">Coming Soon</a>
						</div>
					</div>
				</div>
			...
			<div class="row align-center">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<a href="#" class="btn btn--large btn--transparent btn--dark-lighter" id="load-more-button"
						data-load-link="events-to-load.html" data-container="portfolio-grid">Load More</a>
				</div>
			</div>
		</div>
	</section>
