			...
			<div class="row align-center mb60">
				<div class="col-lg-8 col-lg-offset-2 col-md-12 col-sm-12 col-xs-12">
					<header class="crumina-module crumina-heading heading--h2 heading--with-decoration">
						...
						<h2 class="heading-title heading--half-colored">Upcoming <span class="weight-bold">Courses</span>
						</h2>
						<div class="heading-text">No matter how busy you may think you are, you must find time for reading, or surrender yourself to self-chosen ignorance.</div>
					</header>
				</div>
			</div>
			<div class="row">
