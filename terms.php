			...
			<div class="row align-center">
				<div class="col-lg-8 col-lg-offset-2 col-md-12 col-sm-12 col-xs-12">
					<header class="crumina-module crumina-heading heading--h2 heading--with-decoration">
						<div class="heading-sup-title">Gentlecrypto Terms</div>
						<h2 class="heading-title heading--half-colored">.<span class="weight-bold">Terms and
								Conditions</span>
						</h2>
						<div class="heading-text">Get to know about us more!</div>
					</header>
				</div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div>
				<div>
					...
					<h3>Welcome to Gentlecrypto Enterprise!</h3> <br> <br>

					These terms and conditions outline the rules and regulations for the use of Gentlecrypto
					Enterprise's Website, located at www.Gentlecrypto.io. <br> <br>

					By accessing this website we assume you accept these terms and conditions. Do not continue to use
					Gentlecrypto Enterprise if you do not agree to take all of the terms and conditions stated on this
					page. <br> <br>
					...
					<h3>Cookies</h3>
					We employ the use of cookies. By accessing Gentlecrypto Enterprise, you agreed to use cookies in
					agreement with the Gentlecrypto Enterprise's Privacy Policy. <br> <br>
					...
					<h3>License</h3>
					Unless otherwise stated, Gentlecrypto Enterprise and/or its licensors own the intellectual property
					rights for all material on Gentlecrypto Enterprise. All intellectual property rights are reserved.
					You may access this from Gentlecrypto Enterprise for your own personal use subjected to restrictions
					set in these terms and conditions.

					You must not:

					<ul>
						<li>Republish material from Gentlecrypto Enterprise</li>
						<li>Sell, rent or sub-license material from Gentlecrypto Enterprise</li>
						<li>Reproduce, duplicate or copy material from Gentlecrypto Enterprise</li>
						<li>Redistribute content from Gentlecrypto Enterprise</li>
					</ul> <br> <br>


					This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the help
					of the Terms And Conditions Template. <br> <br>

					Parts of this website offer an opportunity for users to post and exchange opinions and information
					in certain areas of the website. Gentlecrypto Enterprise does not filter, edit, publish or review
					Comments prior to their presence on the website. Comments do not reflect the views and opinions of
					Gentlecrypto Enterprise,its agents and/or affiliates. Comments reflect the views and opinions of the
					person who post their views and opinions. To the extent permitted by applicable laws, Gentlecrypto
					Enterprise shall not be liable for the Comments or for any liability, damages or expenses caused
					and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on
					this website. <br> <br>

					Gentlecrypto Enterprise reserves the right to monitor all Comments and to remove any Comments which
					can be considered inappropriate, offensive or causes breach of these Terms and Conditions. <br> <br>
					...
					You hereby grant Gentlecrypto Enterprise a non-exclusive license to use, reproduce, edit and
					...
					compensates the absence of Gentlecrypto Enterprise; and (d) the link is in the context of general
					...
					website, you must inform us by sending an e-mail to Gentlecrypto Enterprise. Please include your
					...
					No use of Gentlecrypto Enterprise's logo or other artwork will be allowed for linking absent a
					trademark license agreement. <br> <br>
