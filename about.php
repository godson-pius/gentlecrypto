			...
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb30">
					<div class="author-block author-block--column hover-shadow-left-top">
						<div class="avatar avatar320">
							...
							<div class="avatar avatar320 team-img" style="background-image: url('img/escrow.jpg');">
							</div>
						</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb30">
					<div class="author-block author-block--column hover-shadow-left-top">
						<div class="avatar avatar320">
							<!-- <img src="img/author1-320.jpg" alt="avatar"> -->
							<div class="avatar avatar320 team-img" style="background-image: url('img/pub.jpg');">
							</div>
						</div>
						<div class="author-content">
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb30">
					<div class="author-block author-block--column hover-shadow-bottom">
						<div class="avatar avatar320">
							<div class="avatar avatar320 team-img" style="background-image: url('img/com.jpg');">
							</div>
						</div>
						<div class="author-content">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="author-block author-block--column hover-shadow-right-top">
						<div class="avatar avatar440">
							...
							<div class="avatar avatar440 team-ceo" style="background-image: url('img/ceogentle.jpg');">
							</div>
						</div>
						<div class="author-content">
							<a href="#" class="h6 author-name">Igwenagu Emmanuel Chinecherem</a>
							<div class="author-prof">Chief Executive Officer and Founder</div>
						</div>
					</div>
				</div>
			</div>
	...
	<section class="subsidiaries">
		<div class="container">
			<div class="row medium-padding120 align-center">
				<div class="col-lg-8 col-lg-offset-2 col-md-12 col-sm-12 col-xs-12">
					<header class="crumina-module crumina-heading heading--h2 heading--with-decoration">
						<h2 class="heading-title heading--half-colored">Our Subsidiaries</h2>
					</header>
				</div>
			</div>
		</div>
